...
export const AlmuerzoMenu = () => {
    const [almuerzo, setAlmuerzo] = useState<"mediterraneo" | "internacional" | "caribeño" | "saludable">("mediterraneo");
    ...
    return (
        <article className={Style.container}>
            ...
            <div className={Style.buttonConainer}>
                ...
                <button onClick={() => setAlmuerzo("caribeño")} className={almuerzo === "caribeño" ? Style.select : ""}>Caribeño</button>
